    ...
    <div className="flex flex-col min-h-screen bg-[#0B2545] pt-28">
      ...
      <section className={cn(theme.layout.section, "pb-24")}>
        <div className={theme.layout.container}>
          ...
          {!isLoadingAllMatches && !isErrorAllMatches && totalPages > 1 && (
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 bg-[#13315C] border-2 border-[#111111] p-4 shadow-[4px_4px_0px_0px_rgba(17,17,17,1)] mb-6">
